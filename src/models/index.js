...
db.Home = require('./home.model')(sequelize, DataTypes);
db.Process = require('./process.model')(sequelize, DataTypes);
db.ContactPage = require('./contact.page.model')(sequelize, DataTypes);
